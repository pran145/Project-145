...
def drivinglicense():
    idd=630291234
    print(type(idd))
    name="Pranav Cherukuru"
    print(type(name))
    dateofbirth="3/17/2005"
    print(type(dateofbirth))
    pinno=345678
    print(type(pinno))
    address="905 Pinwheel Dr"
    print(type(address))
    vehicletypes=["Two", "Four"]
    print(type(vehicletypes))
    
    label_id['text']=idd
    label_name['text']=name
    label_dob['text']=dateofbirth
    label_pin['text']=pinno
    label_address['text']=address
    label_vehicle_type['text']=vehicletypes
